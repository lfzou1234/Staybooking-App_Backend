...
public class AuthenticationService {
    private AuthenticationManager authenticationManager; // check username password
    private AuthorityRepository authorityRepository; // check host or guest
    ...
    public Token authenticate(User user, UserRole role) throws UserNotExistException {
        ...
        //orElse -> if role not exist, set it as null
